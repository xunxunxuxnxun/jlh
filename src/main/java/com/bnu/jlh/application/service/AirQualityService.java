...
public interface AirQualityService {
	 ...
	 * @return
	 */
	public List<AirQualityStation> findDataByEquipmentNOAndData(String equipmentNO,String data);
	 ...
	 * @return
	 */
	List<AirQualityStation> findHistoryOfEquipment(String equipmentNO);
	 ...
	 * @return
	 */
	List<AirQualityStation> findDataOneDay(String equipmentNO);
	 ...
	 * @return
	 */
	ResponseWrapper saveAir(AirQualityStation air);
	/**
